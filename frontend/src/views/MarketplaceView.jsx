        ...
        addresses.map(async (addr) => {
          try {
            ...
            return {
              ...
              unitPriceWei,
              priceVisibility: listingMeta.priceVisibility || state.priceVisibility || "public",
              proofFamily: listingMeta.proofFamily || "",
              priceCommitment: meta?.priceCommitment || listingMeta.priceCommitment || state.priceCommitment || "",
