...
must_haves:
  ...
  key_links:
    - from: "frontend/src/components/railgun/PrivatePaymentModal.jsx"
      ...
      via: "privateTransfer, getAllBalances imports"
      pattern: "import.*railgun-clean"
    - from: "frontend/src/components/railgun/PrivatePaymentModal.jsx"
...
Target: ~250-350 lines total.
  ...
  <done>PrivatePaymentModal rewritten as 3-step drawer (~300 lines, down from 1632). Fast-path for already-connected users. Buyer enters amount, private transfer executes, recordPrivatePayment called automatically. All dead code removed.</done>
</task>
