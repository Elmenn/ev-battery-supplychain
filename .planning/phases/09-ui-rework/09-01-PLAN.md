...
2. Create `frontend/src/utils/escrowHelpers.js` with:
  ...
  <done>escrowHelpers.js exports all contract interaction functions and constants. getProductState reads id, memoHash, and railgunTxRef from contract. No scattered contract instantiation needed in components.</done>
</task>
